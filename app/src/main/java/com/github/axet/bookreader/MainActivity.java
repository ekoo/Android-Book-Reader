...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setWindow(new ZLApplicationWindow() {
            ...
            public ZLViewWidget getViewWidget() {
                return (ZLViewWidget) findViewById(R.id.main_view);
            }
    ...
    void loadBook(Book book) {
        try {
            final PluginCollection pluginCollection = PluginCollection.Instance(info);
            FormatPlugin plugin = BookUtil.getPlugin(pluginCollection, book);
            BookModel Model = BookModel.createModel(book, plugin);
