...
public class LibraryFragment extends Fragment implements MainActivity.SearchListener {
    ...
    public static class FragmentHolder {
        ...
        public void create(View v) {
            ...
            grid.addItemDecoration(new RecyclerViewFooter(grid, footer));
        ...
        public void onBindViewHolder(final BookHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Storage.Book b = books.getItem(holder.getAdapterPosition());
                    main.loadBook(b);
                }
            });
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    final Storage.Book b = books.getItem(holder.getAdapterPosition());
                    PopupMenu popup = new PopupMenu(getContext(), holder.itemView);
    ...
    public static abstract class BooksAdapter extends UriImagesAdapter<BooksAdapter.BookHolder> {
        ...
        public void onBindViewHolder(BookHolder holder, int position) {
            ...
            if (cover != null) {
                downloadTask(cover, holder.itemView);
            } else {
                downloadTaskUpdate(null, cover, holder.itemView);
            }

            setText(holder.aa, getAuthors(position));
            setText(holder.tt, getTitle(position));
        }
